...
macro_rules! list_resources {
    ($description:tt,$resources_prefix:tt) => {
        ...
        use crate::modules::{Result as ModuleResult, Error as ModuleError, ErrorKind as ModuleErrorKind, Module};
        use crate::modules::infrastructure::Resource;
        use crate::modules::infrastructure::errors::*;
        use crate::output::OutputType;
        use crate::output::infrastructure::{JsonOutputResourceListResult, OutputResourceListResult, PlainOutputResourceListResult, TableOutputResourceListResult};
...
macro_rules! build_resource {
    ($description:tt,$resources_prefix:tt,$($command:tt),+) => {
        ...
        use crate::run_config::RunConfig;
        use tempfile;
        use crate::utils::command::{Command, CommandResult};
        use crate::utils::run;
