...
use crate::modules::*;
use crate::modules::consul::NodeField;
use crate::output::OutputType;
use crate::output::consul::{JsonOutputCatalogResult, OutputCatalogResult, PlainOutputCatalogResult, TableOutputCatalogResult};
